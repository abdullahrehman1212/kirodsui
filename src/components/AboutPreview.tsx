        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6">
              Since 2009, Kirods has been at the forefront of business innovation, 
              providing cutting-edge solutions that empower companies to achieve their goals. 
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg mb-6">
              ...
              <p className="text-gray-600">
                To democratize business technology by making premium solutions accessible, 
                reliable, and affordable for companies of all sizes. We believe every business 
                deserves the tools to succeed in today's digital landscape.
              </p>
            </div>
